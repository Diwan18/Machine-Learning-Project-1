...
uni = pd.read_excel(r"D:\Machine Learning ataset\University_Clustering.xlsx")
...
hc_2clust = AgglomerativeClustering(n_clusters = 2, affinity = 'euclidean', linkage = 'average')
